...
const n=_(a,(e,i)=>"none"===i.value&&null==t.selectedTrack||t.selectedTrack&&i.value===t.selectedTrack.srclang)
...
u["a"].MepDefaults.success=function(e,t){i.e(4249).then(i.bind(null,"eTZi")).then(({default:t})=>{t(this.mediaCommentId,e,INST.kalturaSettings)})
return e.play()}
...
let g=false
let b=null
c.a.mediaComment.init=function(e,t){Promise.all([i.e(9),i.e(25),i.e(33),i.e(3836)]).then((()=>{const a=i("ufgb")
b=b||new Date
e=e||"any"
t=t||{}
...
const o=n();("Chrome"===o.name&&Number(o.version)>=68||"Firefox"===o.name&&Number(o.version)>=61)&&Promise.all([i.e(1),i.e(2),i.e(3),i.e(5),i.e(14),i.e(18),i.e(119),i.e(4108)]).then(i.bind(null,"2Ema")).then(({default:e})=>{let t
...
n.addEventListener("volumechange",(function(e){if(!_)if(n.muted){p(0)
...
return this},determinePlayback:function(e,t,i,n,o){var r,s,l,d,u,c,m,p,f,_,h,g=[],b={method:"",url:"",htmlMediaElement:e,isVideo:"audio"!==e.tagName.toLowerCase(),scheme:""}
...
h=u.getAttribute("media");(!h||!window.matchMedia||window.matchMedia&&window.matchMedia(h).matches)&&g.push({type:c,url:o})}}!n&&g.length>0&&null!==g[0].url&&this.getTypeFromFile(g[0].url).indexOf("audio")>-1&&(b.isVideo=false)
...
if(i&&("auto"===t.mode||"auto_plugin"===t.mode||"native"===t.mode)&&!(a.MediaFeatures.isBustedNativeHTTPS&&true===t.httpsBasicAuthSite)){if(!n){_=document.createElement(b.isVideo?"video":"audio")
...
t.error(n)},createPlugin:function(e,t,i,n,o,r){var s,l,d,u=e.htmlMediaElement,c=1,m=1,p="me_"+e.method+"_"+a.meIndex++,f=new a.PluginMediaElement(p,e.method,e.url),_=document.createElement("div")
f.tagName=u.tagName
...
if(v&&!b){h=0
for(var y=v.length;h<y;h++)"audio/mp4"===v[h].getAttribute("type")&&(b=true)}d=["id="+p,"isvideo="+(e.isVideo||b?"true":"false"),"autoplay="+(n?"true":"false"),"preload="+o,"width="+c,"startvolume="+t.startVolume,"timerrate="+t.timerRate,"flashstreamer="+t.flashStreamer,"height="+m,"pseudostreamstart="+t.pseudoStreamingStartQueryParam]
...
void 0===e.en&&(e.en={"mejs.plural-form":1,"mejs.download-file":"Download File","mejs.fullscreen-off":"Turn off Fullscreen","mejs.fullscreen-on":"Go Fullscreen","mejs.download-video":"Download Video","mejs.fullscreen":"Fullscreen","mejs.time-jump-forward":["Jump forward 1 second","Jump forward %1 seconds"],"mejs.play":"Play","mejs.pause":"Pause","mejs.close":"Close","mejs.time-slider":"Time Slider","mejs.time-help-text":"Use Left/Right Arrow keys to advance one second, Up/Down arrows to advance ten seconds.","mejs.time-skip-back":["Skip back 1 second","Skip back %1 seconds"],"mejs.captions-subtitles":"Captions/Subtitles","mejs.none":"None","mejs.mute-toggle":"Mute Toggle","mejs.volume-help-text":"Use Up/Down Arrow keys to increase or decrease volume.","mejs.unmute":"Unmute","mejs.mute":"Mute","mejs.volume-slider":"Volume Slider","mejs.video-player":"Video Player","mejs.audio-player":"Audio Player","mejs.ad-skip":"Skip ad","mejs.ad-skip-info":["Skip in 1 second","Skip in %1 seconds"],"mejs.source-chooser":"Source Chooser"})})(a.i18n.locale.strings)},O3h1:function(e,t,i){var a={"./me-i18n-locale-cs":["Zjte",3669],"./me-i18n-locale-cs.js":["Zjte",3669],"./me-i18n-locale-de":["C7He",3670],"./me-i18n-locale-de.js":["C7He",3670],"./me-i18n-locale-en":["tYpR",3671],"./me-i18n-locale-en.js":["tYpR",3671],"./me-i18n-locale-es":["KY2I",3672],"./me-i18n-locale-es.js":["KY2I",3672],"./me-i18n-locale-fr":["HiGp",3673],"./me-i18n-locale-fr.js":["HiGp",3673],"./me-i18n-locale-hu":["/Xzx",3674],"./me-i18n-locale-hu.js":["/Xzx",3674],"./me-i18n-locale-it":["bsL9",3675],"./me-i18n-locale-it.js":["bsL9",3675],"./me-i18n-locale-ja":["aVOL",3676],"./me-i18n-locale-ja.js":["aVOL",3676],"./me-i18n-locale-ko":["xv0d",3677],"./me-i18n-locale-ko.js":["xv0d",3677],"./me-i18n-locale-nl":["GE+S",3678],"./me-i18n-locale-nl.js":["GE+S",3678],"./me-i18n-locale-pl":["x7au",3679],"./me-i18n-locale-pl.js":["x7au",3679],"./me-i18n-locale-pt":["on1a",3681],"./me-i18n-locale-pt-br":["OMPk",3680],"./me-i18n-locale-pt-br.js":["OMPk",3680],"./me-i18n-locale-pt.js":["on1a",3681],"./me-i18n-locale-ro":["Wvze",3682],"./me-i18n-locale-ro.js":["Wvze",3682],"./me-i18n-locale-ru":["5Xva",3683],"./me-i18n-locale-ru.js":["5Xva",3683],"./me-i18n-locale-sk":["jZcU",3684],"./me-i18n-locale-sk.js":["jZcU",3684],"./me-i18n-locale-zh":["s1kf",3686],"./me-i18n-locale-zh-cn":["s2+q",3685],"./me-i18n-locale-zh-cn.js":["s2+q",3685],"./me-i18n-locale-zh.js":["s1kf",3686]}
...
Promise.all([i.e(1),i.e(2),i.e(3),i.e(9),i.e(4138)]).then(i.bind(null,"KWYq")).then(({default:e})=>{new e(t.options.mediaCommentId,t.media.src)})})
...
var m=[]
var p=false
for(var f=0,_=o.options.speeds.length;f<_;f++){var h=o.options.speeds[f]
if("string"===typeof h){m.push({name:h+o.options.speedChar,value:h})
h===o.options.defaultSpeed&&(p=true)}else{m.push(h)
h.value===o.options.defaultSpeed&&(p=true)}}p||m.push({name:o.options.defaultSpeed+o.options.speedChar,value:o.options.defaultSpeed})
...
i.insertBefore(t,n)}}function h(e){if(null===e.parentNode)return false
...
//# sourceMappingURL=47-c-815b8d3d32.js.map