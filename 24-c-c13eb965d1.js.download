...
Promise.all([n.e(2),n.e(3),n.e(6),n.e(20),n.e(111),n.e(4114)]).then(n.bind(null,"PrO8")).then(({default:t})=>{const n=document.createElement("div")
document.body.appendChild(n)
c.a.render(Object(o["a"])(t,{win:window,editor:e,contextAssetString:ENV.context_asset_string,iframeAllowances:Object(u["a"])(),resourceSelectionUrl:_()("#context_external_tool_resource_selection_url").attr("href"),deepLinkingOrigin:ENV.DEEP_LINKING_POST_MESSAGE_ORIGIN}),n,(function(){l=this}))})
const i=[]
...
document.addEventListener("tinyRCE/initEquation",({detail:t})=>{Promise.all([n.e(0),n.e(9),n.e(4139)]).then(n.bind(null,"dIBj")).then(({default:n})=>{const o=new n(t.ed)
e.equationCB(o)}).catch(Object(T["c"])(q.t("Something went wrong loading the equation editor")))})
document.addEventListener("tinyRCE/initEquella",t=>{Promise.all([n.e(0),n.e(4251)]).then(n.bind(null,"IOhY")).then(({default:n})=>{n(t.detail.ed)
e.equellaCB()}).catch(Object(T["c"])(q.t("Something went wrong loading Equella")))})
document.addEventListener("tinyRCE/initExternalTools",t=>{v.init(t.detail.ed,t.detail.url,b["a"])
e.externalToolCB()})}},JiFB:function(e,t,n){"use strict"
n.d(t,"a",(function(){return l}))
var o=n("uYtQ")
var a=n("ErZx")
class l{constructor(e,t,n,o){this.baseURL=e.baseURL
...
let o;(function(e){e[e["ButtonsAndIcons"]=0]="ButtonsAndIcons"})(o||(o={}))
function a(e,t){switch(e){case o.ButtonsAndIcons:return l(t)
default:return false}}function l(e){var t,n
return!!(e.RICH_CONTENT_CAN_UPLOAD_FILES&&e.RICH_CONTENT_CAN_EDIT_FILES&&null!==(t=window.ENV)&&void 0!==t&&null!==(n=t.FEATURES)&&void 0!==n&&n.buttons_and_icons_root_account)}},eVns:function(e,t,n){"use strict"
...
return n}}var l=n("s9Pr")
function i(){if(!ENV.context_asset_string)return null
let[e,t]=Object(l["a"])(ENV.context_asset_string,false)
const n=ENV.current_user_id
const o={contextType:e,contextId:t,userId:n}
const i=ENV.RICH_CONTENT_CAN_UPLOAD_FILES
if(!i||"account"===e){t=n
e="user"}return{canUploadFiles:ENV.RICH_CONTENT_CAN_UPLOAD_FILES,containingContext:o,contextType:e,contextId:t,filesTabDisabled:ENV.RICH_CONTENT_FILES_TAB_DISABLED,host:ENV.RICH_CONTENT_APP_HOST,jwt:ENV.JWT,refreshToken:a(ENV.JWT),themeUrl:ENV.active_brand_config_json_url}}}}])

//# sourceMappingURL=24-c-c13eb965d1.js.map