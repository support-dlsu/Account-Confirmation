(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[63],{"6NVu":function(e,n,t){"use strict"
...
var w=(R=Object(g["j"])(h,G),R(k=(B=v=function(e){Object(i["a"])(t,e)
var n=Object(c["a"])(t)
function t(){Object(r["a"])(this,t)
return n.apply(this,arguments)}Object(o["a"])(t,[{key:"render",value:function(){var e
var n=this.props,r=n.wrap,o=n.weight,i=n.fontStyle,c=n.size,m=n.lineHeight,l=n.letterSpacing,d=n.transform,p=n.color,g=n.children
var f=Object(b["a"])(t,this.props)
return _.a.createElement(f,Object.assign({},Object(u["b"])(this.props),{className:s()((e={},Object(a["a"])(e,G.root,true),Object(a["a"])(e,G[c],c),Object(a["a"])(e,G["wrap-".concat(r)],r),Object(a["a"])(e,G["weight-".concat(o)],o),Object(a["a"])(e,G["style-".concat(i)],i),Object(a["a"])(e,G["transform-".concat(d)],d),Object(a["a"])(e,G["lineHeight-".concat(m)],m),Object(a["a"])(e,G["letterSpacing-".concat(l)],l),Object(a["a"])(e,G["color-".concat(p)],p),e)),ref:this.props.elementRef}),g)}}])
t.displayName="Text"
...
var l=t.n(_)
var d=t("6NVu")
const p={normal:{width:140,height:100},small:{width:70,height:50}}
function s(e,n,t){if(!INST.kalturaSettings)return console.log("Kaltura has not been enabled for this account")
let a,r
const i=l()(e)
try{const e=document.createElement("a")
e.href=i.attr("href")
r=e}catch(e){}if(r&&Object(d["a"])(r.search).no_preview)return
const c=p[n]||p.normal
...
const s=i.data("author")
const g=i.data("created_at")
let b
b=s&&g?o.t("Play media comment by %{name} from %{createdAt}.",{name:s,createdAt:g}):o.t("Play media comment.")
...
d.data("download",d.attr("href")).prop("href","#").addClass("instructure_inline_media_comment").append(r).css({backgroundImage:"",padding:0})}}l.a.fn.mediaCommentThumbnail=function(e="normal",n){return this.each((function(){c.a.defer(s,this,e,n)}))}}}])

//# sourceMappingURL=63-c-f52ef6a406.js.map